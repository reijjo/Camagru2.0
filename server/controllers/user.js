...
usersRouter.post("/register", async (req, res) => {
  ...
  const options = {
    ...
    html: `<h1>Hi! Click the link: <a href='https://camagru2.onrender.com/register/${codeHash}'> Here! </a> </h1>`,
...
usersRouter.post("/forgot", async (req, res) => {
  ...
  const options = {
    ...
    html: `<h1>Click the link to change your password: <a href='https://https://camagru2.onrender.com/forgot/${user.verifyCode}'> THE LINK </a> </h1>`,
